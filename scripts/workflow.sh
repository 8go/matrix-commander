...
OPT4="scripts/update-2-help.py # update help file"
OPT5="scripts/update-3-readme.py # update README.md file"
OPT6="scripts/lintmc.sh # lint and beautify main file"
OPT7="scripts/pypi-package-1-create.sh # create PyPi release"
OPT8="scripts/pypi-package-2-publish.sh # optionally publish PyPi release; maybe skip this for minor versions; skip this if Actions workflow is preferred"
OPTC="Continue"
OPTQ="Quit"
